---
name: autoxpp-load-senior-fo-dev
description: >-
  Loads the Senior D365 F&O Developer role for pre-lifecycle work:
  investigation, debugging, code research, solution design, root cause
  analysis. No arguments — just invoke and start working.
---
...
1. Call the `autoxpp` MCP tool `get_skill_content` with `skill_name=load-senior-fo-dev`
