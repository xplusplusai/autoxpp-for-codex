---
name: autoxpp-init-session
description: >-
  Initializes an AutoXPP session. Must be called before any other autoxpp skill
  in a conversation. Sets up session context on the MCP server.
---
...
1. Call the `autoxpp` MCP tool `init_autoxppsession`
